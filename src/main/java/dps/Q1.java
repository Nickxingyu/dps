...
public class Q1 
{
    public static void main( String[] args )
    {
        ...
        List<String> list_of_all_guid = Arrays.asList(
            "lipstick_item_guid", "blush_item_guid", "eyebrows_item_guid", "eyecolor_item_guid", "eyelashes_item_guid", 
            "eyeliner_item_guid", "foundation_item_guid", "wig_item_guid", "eyewear_pattern_guid", "headband_pattern_guid", 
            "necklace_pattern_guid", "earrings_pattern_guid", "fakeeyelashes_palette_guid", "haircolor_item_guid", "hairDye_item_guid",
            "eyeshadow_item_guid_list", "face_contour_item_guid_list");
		...
		for(int i = 0; i < 1/*recived_days.length*/;i++){
            ...
            //drop_duplicate_feature.show(100,0,true);
			...
			guid_events.write().mode("append").partitionBy("f_timestamp_day","e_key").parquet("s3a://pf-new-hire/temp/dps-q1/");
			guid_list_events.write().mode("append").partitionBy("f_timestamp_day","e_key").parquet("s3a://pf-new-hire/temp/dps-q1/");
		}	
    }
}
